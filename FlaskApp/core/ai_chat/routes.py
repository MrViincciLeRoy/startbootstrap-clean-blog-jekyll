...
def setup_ai_chat_routes(bp):
    ...
    @bp.route('/api/ai-chat/index', methods=['POST'])
    @login_required
    def index_posts():
    ...
    @bp.route('/api/ai-chat/search', methods=['POST'])
    @login_required
    def search_posts():
    ...
    @bp.route('/api/ai-chat/ask', methods=['POST'])
    @login_required
    def ask_question():
    ...
    @bp.route('/api/ai-chat/status', methods=['GET'])
    @login_required
    def get_status():
